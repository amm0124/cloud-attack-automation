  ...
  return (
    <Layout>
      <div className="scanning-menu-page">
        ...
        <p className="page-description">수집한 자격 증명 정보로 접근 가능한 AWS(Amazon Web Service) 주요 서비스 및 Jenkins 취약점 분석</p>
          ...
          <div className="scanning-options">
              ...
              <div className="option-card">
                  ...
                  <p>Jenkins 취약점 분석</p>
                  <ul>
                      <li>Jenkins 라이브러리 버전 검사</li>
                      <li>Jenkins 라이브러리 취약점 분석</li>
                  </ul>
                  <Link to="/analyzing/jenkins" className="option-button">시작하기</Link>
              </div>
          </div>
      </div>
    </Layout>
