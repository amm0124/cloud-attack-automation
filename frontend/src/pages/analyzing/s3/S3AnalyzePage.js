...
import './S3AnalyzePage.css';

function S3AnalyzingPage() {
  ...
  const startScan = () => {
    ...
    // 새 WebSocket 연결 생성
    const ws = new WebSocket('ws://localhost:8000/ws/analyzing/aws/s3');
    wsRef.current = ws;
      ...
      <div className="scanning-page">
        ...
        <div className="scan-form">
          ...
          <div className="button-group">
            <button className="start-btn" onClick={startScan}>분석 시작</button>
...
export default S3AnalyzingPage;