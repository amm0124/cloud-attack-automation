...
import './JenkinsAnalyzePage.css';

function JenkinsAnalyzingPage() {
    ...
    const startScan = () => {
        ...
        ws.onopen = () => {
            ...
            ws.send(JSON.stringify({
                jenkins_url : "http://" + ipAddress + ":8080/"
            }));
        };
    ...
    return (
        <Layout>
            <div className="scanning-page">
                <h2>Jenkins</h2>
                <p className="page-description">Jenkins 라이브러리 취약점 분석</p>

                <div className="scan-form">
                    <div className="form-group">
                        <label htmlFor="target">IP 주소</label>
                        <input
                            type="text"
                            id="ip-address"
...
export default JenkinsAnalyzingPage;