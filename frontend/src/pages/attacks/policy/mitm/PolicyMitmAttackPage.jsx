...
import './PolicyMitmAttackPage.css';


function PolicyMitmAttackPage() {
  ...
  return (
    <Layout>
      <div className="scanning-page">
        <h2>PolicyMitmAttackPage</h2>
        <p className="page-description">PolicyMitmAttackPage</p>

        <div className="scan-form">
          <div className="form-group">
            <label htmlFor="target">PolicyMitmAttackPage</label>
            <input
              type="text"
              id="target"
              placeholder="PolicyMitmAttackPage"
            />
          </div>
...
export default PolicyMitmAttackPage;
